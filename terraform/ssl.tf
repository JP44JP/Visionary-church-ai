...
# ACM Certificate for the main domain and wildcard subdomains
...
# API subdomain record pointing to ALB
...
# CloudFront distribution for the frontend and tenant subdomains
